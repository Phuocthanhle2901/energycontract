...
namespace styx2_crs_send.Core
{
    public enum LoggingEnum
    {
        ...
        SCS0010,
        [Log("Request to CRS service returned no result.", "SCS-0011", LogLevel.Warn)]
        SCS0011,
        ...
        [Log("Circuit breaker is at Open state!", "SCS-0101", LogLevel.Warn)]
        SCS0101,
        [Log("Circuit breaker is at Closed state!", "SCS-0102", LogLevel.Warn)]
        SCS0102,
        [Log("Circuit breaker is at Half-Open state! Next call will be a trial.", "SCS-0103", LogLevel.Warn)]
        SCS0103,
