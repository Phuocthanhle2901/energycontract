...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div>
        <h2 style={{ marginBottom: "2rem", color: "var(--text)", fontSize: "1.6rem", fontWeight: 700 }}>
          📊 Dashboard Overview
        </h2>
                ...
                {contracts.slice(0, 5).map((c) => {
                  ...
                  return (
                    <tr key={c.id}>
                      ...
                      <td>
                        <span
                          className={isActive ? "status-badge status-active" : "status-badge status-expired"}
                        >
      ...
      {/* Quick Actions */}
      <div>
        <h2 style={{ marginTop: "3rem", marginBottom: "2rem", color: "var(--text)", fontSize: "1.6rem", fontWeight: 700 }}>
          🚀 Quick Actions
        </h2>
        <div className="card-grid">
