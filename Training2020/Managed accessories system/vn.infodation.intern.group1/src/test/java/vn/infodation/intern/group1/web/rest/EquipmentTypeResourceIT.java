...
import vn.infodation.intern.group1.repository.EquipmentTypeRepository;
...
public class EquipmentTypeResourceIT {
    ...
    public void createEquipmentType() throws Exception {
        ...
        restEquipmentTypeMockMvc.perform(post("/api/equipment-types").with(csrf())
    ...
    public void updateEquipmentType() throws Exception {
        ...
        restEquipmentTypeMockMvc.perform(put("/api/equipment-types").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteEquipmentType() throws Exception {
        ...
        restEquipmentTypeMockMvc.perform(delete("/api/equipment-types/{id}", equipmentType.getId()).with(csrf())
