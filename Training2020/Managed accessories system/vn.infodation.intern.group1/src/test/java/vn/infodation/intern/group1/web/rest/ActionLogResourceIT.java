...
import vn.infodation.intern.group1.domain.ActionLog;
import vn.infodation.intern.group1.domain.Employee;
import vn.infodation.intern.group1.domain.ActionType;
import vn.infodation.intern.group1.domain.PlaceToPerform;
import vn.infodation.intern.group1.domain.Equipment;
import vn.infodation.intern.group1.repository.ActionLogRepository;
...
public class ActionLogResourceIT {
    ...
    public void createActionLog() throws Exception {
        ...
        restActionLogMockMvc.perform(post("/api/action-logs").with(csrf())
    ...
    public void updateActionLog() throws Exception {
        ...
        restActionLogMockMvc.perform(put("/api/action-logs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteActionLog() throws Exception {
        ...
        restActionLogMockMvc.perform(delete("/api/action-logs/{id}", actionLog.getId()).with(csrf())
