...
import vn.infodation.intern.group1.domain.EquipmentGroup;
import vn.infodation.intern.group1.repository.EquipmentGroupRepository;
...
public class EquipmentGroupResourceIT {
    ...
    public void createEquipmentGroup() throws Exception {
        ...
        restEquipmentGroupMockMvc.perform(post("/api/equipment-groups").with(csrf())
    ...
    public void updateEquipmentGroup() throws Exception {
        ...
        restEquipmentGroupMockMvc.perform(put("/api/equipment-groups").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteEquipmentGroup() throws Exception {
        ...
        restEquipmentGroupMockMvc.perform(delete("/api/equipment-groups/{id}", equipmentGroup.getId()).with(csrf())
