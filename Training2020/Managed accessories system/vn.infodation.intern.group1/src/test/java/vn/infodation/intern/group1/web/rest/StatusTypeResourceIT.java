...
import vn.infodation.intern.group1.repository.StatusTypeRepository;
...
public class StatusTypeResourceIT {
    ...
    public void createStatusType() throws Exception {
        ...
        restStatusTypeMockMvc.perform(post("/api/status-types").with(csrf())
    ...
    public void updateStatusType() throws Exception {
        ...
        restStatusTypeMockMvc.perform(put("/api/status-types").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteStatusType() throws Exception {
        ...
        restStatusTypeMockMvc.perform(delete("/api/status-types/{id}", statusType.getId()).with(csrf())
