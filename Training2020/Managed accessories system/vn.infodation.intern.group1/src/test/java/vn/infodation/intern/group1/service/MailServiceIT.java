...
public class MailServiceIT {
    ...
    public void testSendEmailFromTemplate() throws Exception {
        ...
        assertThat(message.getFrom()[0].toString()).isEqualTo(jHipsterProperties.getMail().getFrom());
        assertThat(message.getContent().toString()).isEqualToNormalizingNewlines("<html>test title, https://172.16.20.167:8080, john</html>\n");
        assertThat(message.getDataHandler().getContentType()).isEqualTo("text/html;charset=UTF-8");
    }
    ...
    public void testSendLocalizedEmailForAllSupportedLanguages() throws Exception {
        ...
        for (String langKey : languages) {
            ...
            assertThat(message.getContent().toString()).isEqualToNormalizingNewlines("<html>" + emailTitle + ", https://172.16.20.167:8080, john</html>\n");
        }
    }
