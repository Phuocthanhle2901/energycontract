...
import vn.infodation.intern.group1.repository.ActionTypeRepository;
...
public class ActionTypeResourceIT {
    ...
    public void createActionType() throws Exception {
        ...
        restActionTypeMockMvc.perform(post("/api/action-types").with(csrf())
    ...
    public void updateActionType() throws Exception {
        ...
        restActionTypeMockMvc.perform(put("/api/action-types").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteActionType() throws Exception {
        ...
        restActionTypeMockMvc.perform(delete("/api/action-types/{id}", actionType.getId()).with(csrf())
