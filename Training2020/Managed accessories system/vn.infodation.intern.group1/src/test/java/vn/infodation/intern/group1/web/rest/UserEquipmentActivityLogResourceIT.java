...
import vn.infodation.intern.group1.repository.UserEquipmentActivityLogRepository;
...
public class UserEquipmentActivityLogResourceIT {
    ...
    public void createUserEquipmentActivityLog() throws Exception {
        ...
        restUserEquipmentActivityLogMockMvc.perform(post("/api/user-equipment-activity-logs").with(csrf())
    ...
    public void updateUserEquipmentActivityLog() throws Exception {
        ...
        restUserEquipmentActivityLogMockMvc.perform(put("/api/user-equipment-activity-logs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteUserEquipmentActivityLog() throws Exception {
        ...
        restUserEquipmentActivityLogMockMvc.perform(delete("/api/user-equipment-activity-logs/{id}", userEquipmentActivityLog.getId()).with(csrf())
