...
import vn.infodation.intern.group1.repository.StatusLogRepository;
...
public class StatusLogResourceIT {
    ...
    public void createStatusLog() throws Exception {
        ...
        restStatusLogMockMvc.perform(post("/api/status-logs").with(csrf())
    ...
    public void updateStatusLog() throws Exception {
        ...
        restStatusLogMockMvc.perform(put("/api/status-logs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteStatusLog() throws Exception {
        ...
        restStatusLogMockMvc.perform(delete("/api/status-logs/{id}", statusLog.getId()).with(csrf())
