...
import vn.infodation.intern.group1.repository.PlaceToPerformRepository;
...
public class PlaceToPerformResourceIT {
    ...
    public void createPlaceToPerform() throws Exception {
        ...
        restPlaceToPerformMockMvc.perform(post("/api/place-to-performs").with(csrf())
    ...
    public void updatePlaceToPerform() throws Exception {
        ...
        restPlaceToPerformMockMvc.perform(put("/api/place-to-performs").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deletePlaceToPerform() throws Exception {
        ...
        restPlaceToPerformMockMvc.perform(delete("/api/place-to-performs/{id}", placeToPerform.getId()).with(csrf())
